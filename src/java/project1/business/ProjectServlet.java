...
public class ProjectServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Cookie c = new Cookie("userIDCookie", "mike110");
        c.setMaxAge(60*60*24*365*2);    //two year age on cookie
        c.setPath("/");
        ...
        getServletContext().getRequestDispatcher("/bio.jsp").forward(request, response);
    }
